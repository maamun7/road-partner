...
<div class="box box-success">
	...
	<div class="box-body">
		...
		<div class="col-md-6">
			<div class="form-group <?php if (isset($error_course_key) && $error_course_key != ''){ echo 'has-error'; } ?>">
                ...
                <input type="text" tabindex="2" class="form-control" name="course_key" value="<?php if (isset($course_key_value)) { echo $course_key_value; } ?>" placeholder="Enter course key" />
	...
	<div class="box-footer clearfix">
		<div class="pull-right">
			<input type="submit" class="btn btn-success" name="add-course" value="Save" />
			<input type="submit" class="btn btn-info" name="add-course-another" value="Save and add another one" />
		</div>
	</div>
	</form>
</div>